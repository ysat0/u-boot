/*
 * Configuation settings for the h8300h simulator
 *
...
#ifndef __H8300H_SIM_H
#define __H8300H_SIM_H
...
#define CONFIG_SYS_DRAM_SIZE		0x200000

#define CONFIG_SYS_MEMTEST_START	0x400000
#define CONFIG_SYS_MEMTEST_END		(0x600000 - 0x004000)
